...
import com.dbsh.skup.databinding.HomeTmpFormBinding;
import com.dbsh.skup.tmpstructure.viewmodels.HomeViewModel;
...
public class HomeActivity extends AppCompatActivity {
	...
	private long time = 0;
	private HomeTmpFormBinding binding;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		/* DataBinding */
		binding = DataBindingUtil.setContentView(this, R.layout.home_tmp_form);
