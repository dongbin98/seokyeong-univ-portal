...
import com.dbsh.skup.databinding.SplashTmpFormBinding;
import com.dbsh.skup.tmpstructure.viewmodels.SplashViewModel;
...
public class SplashActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
	    ...
	    /* DataBinding */
	    binding = DataBindingUtil.setContentView(this, R.layout.splash_tmp_form);
