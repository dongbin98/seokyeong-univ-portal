    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        binding.passwordAuthButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                viewModel.getPasswordAuthData(id, binding.passwordAuthName.getText().toString(), binding.passwordAuthBirth.getText().toString());
            }
        });
        ...
        viewModel.authState.observe(getViewLifecycleOwner(), new Observer<String>() {
            ...
            public void onChanged(String s) {
                if(s.equals("S")) {
                    homeRightContainer.pushFragment(PasswordAuthFragment, new PasswordCheckFragment(), null);
                } else if(s.equals("F")) {
