...
public class RequestLecturePlanBookParameterData {
	/**
	 *   "parameter": {
	 *     "LECT_YEAR": "2022",
	 *     "LECT_TERM": "2",
	...
	public RequestLecturePlanBookParameterData(String LECT_YEAR, String LECT_TERM, String SUBJ_CD, String CLSS_NUMB, String STAF_NO) {
